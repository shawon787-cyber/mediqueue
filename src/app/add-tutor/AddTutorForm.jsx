...
export default function AddTutorForm() {
  ...
  return (
    <PrivateRoute>
      <div className={`max-w-xl mx-auto py-12 ${isDark ? "text-gray-200" : ""}`}>
        <h2 className="text-3xl font-bold text-center mb-5">Add New Tutor</h2>
        <form
          onSubmit={onSubmit}
          className={`p-10 space-y-8 shadow-lg rounded-xl ${isDark ? "bg-[#111827]" : "bg-gray-50"}`}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="md:col-span-2">
              <label className="label">
                <span className={`label-text font-semibold ${isDark ? "text-gray-300" : "text-slate-700"}`}>
                  Tutor Name
                </span>
              </label>
              <input
            ...
            <div>
              ...
              <input
                ...
                name="availableDays"
                placeholder="Sun - Thu"
                className={`input input-bordered w-full rounded-xl focus:outline-none focus:border-[#0675c1] ${isDark ? "bg-[#1a2235] border-gray-700 text-white placeholder-gray-500" : ""}`}
                required
              />
            </div>
